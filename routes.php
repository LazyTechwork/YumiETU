...
use Yumi\Http\VkAuthController;
...
return static function (RouteCollection $routes) {
    $routes->add(
        'info',
        new Route('/', ['controller' => InfoController::class])
    );
//    $routes->add(
...
//    );
    $routes->add(
        'hook',
        new Route('/hook', ['controller' => HookController::class])
    );
    $routes->add(
        'vk',
        new Route('/vk', ['controller' => VkAuthController::class])
    );
};